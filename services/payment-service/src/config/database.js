/**
 * CommerceSphere Payment Service — Sequelize Database Configuration
 *
 * Creates and exports a Sequelize instance connected to PostgreSQL.
 * Points to the commercesphere_payments database.
 */

const { Sequelize } = require('sequelize');

const sequelize = new Sequelize(
    process.env.DB_NAME || 'commercesphere_payments',
